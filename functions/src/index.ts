...
// vive en ./shared.ts. Helpers de validación en ./lib/validation.ts.
...
async function computeFinancialHealth() {
  ...
  // Cálculo puro del semáforo y estado de resultados (con tests en
  // functions/src/lib/financial-health.ts)
  return {
    ...computeFinancialSummary(config, meses),
