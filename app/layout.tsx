...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/hero-marketplace.png", width: 1200, height: 630, alt: "Perfil Primero — Plataforma laboral invertida de Chile" }],
    locale: "es_CL",
    type: "website"
  },
  twitter: {
  ...
  return (
    <html lang="es-CL">
      <head>
        ...
        <link rel="preload" href="/logo-perfil-primero.png" as="image" />
        <link rel="icon" href="/logo-perfil-primero.png" type="image/png" />
        <link rel="apple-touch-icon" href="/logo-perfil-primero.png" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "taxID": "78.449.783-6",
              "url": "https://perfil-primero.web.app",
              "logo": "https://perfil-primero.web.app/logo-perfil-primero.png",
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "offers": {
                ...
                "price": "999",
                "priceCurrency": "CLP",
                "description": "Activación de perfil por 30 días o desbloqueo de contacto de candidato"
              }
            }).replace(/</g, "\\u003c")
          }}
        />
      ...
      <body>
        ...
        <footer className="siteFooter" role="contentinfo">
          ...
          <nav aria-label="Footer">
            <a href="/para-postulantes">Para postulantes</a>
            <a href="/para-empresas">Para empresas</a>
            <a href="/para-omil">Para OMIL</a>
          ...
          <span className="footerCredit">© 2026 Perfil Primero SpA · RUT 78.449.783-6 · Puerto Montt, Chile</span>
        </footer>
      </body>
    </html>
  );
