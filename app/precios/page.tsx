...
export const metadata: Metadata = {
  ...
  description: "Postulantes gratis en lanzamiento. Empresas: $9.990 CLP por contacto o $29.990 CLP/mes por contactos ilimitados. Sin comisiones ocultas.",
...
const faqJsonLd = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": { "@type": "Answer", "text": "Las empresas pagan $9.990 CLP por cada contacto desbloqueado, o $29.990 CLP/mes por contactos ilimitados. No hay comisiones adicionales ni costos ocultos." }
    },
    {
      "@type": "Question",
    ...
    <main>
      ...
      <section style={{ maxWidth: 900, margin: "0 auto 0.5rem", padding: "0 1.25rem" }}>
        <div style={{
          ...
          background: "linear-gradient(135deg,#0a2038,#0d2e4a)",
          borderRadius: "14px", padding: "1rem 1.5rem",
          border: "1px solid #0094d4"
        }}>
          <Rocket size={22} color="#0094d4" aria-hidden="true" />
          <div>
      ...
      <section className="pricingCards" aria-label="Precios actuales de lanzamiento" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))" }}>
        <article className="pricingCard">
          ...
          <p style={{ fontSize: "12px", fontWeight: 700, color: "#0094d4", textTransform: "uppercase", letterSpacing: "0.08em", margin: "0 0 0.5rem" }}>
            🚀 Precio de lanzamiento
          </p>
        ...
        <article className="pricingCard">
          ...
          <div className="pricingAmount">
            ...
            <span className="pricingNumber">9.990</span>
      ...
      <section style={{ maxWidth: 760, margin: "0 auto 2rem", padding: "0 1.25rem" }}>
        <div style={{
          ...
          <Rocket size={18} color="#0094d4" style={{ flexShrink: 0, marginTop: "2px" }} aria-hidden="true" />
      ...
      <section style={{ maxWidth: 760, margin: "0 auto 2.5rem", padding: "0 1.25rem" }}>
        <div style={{ textAlign: "center", marginBottom: "1.25rem" }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem" }}>
            <Zap size={18} color="#0094d4" aria-hidden="true" />
        ...
        <div style={{ overflowX: "auto" }}>
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "14px" }}>
            ...
            <tbody>
              {[
                { name: "Perfil Primero · Por contacto 🚀", model: "Pay-per-unlock", cost: "$9.990 CLP (~11 USD)", highlight: true },
                ...
                <tr key={row.name} style={{ background: row.highlight ? "rgba(0,148,212,0.07)" : "transparent" }}>
                  ...
                  <td style={{ padding: "10px 14px", color: row.highlight ? "#0094d4" : "var(--muted-strong)", fontWeight: row.highlight ? 700 : 400, borderBottom: "1px solid var(--line)" }}>{row.cost}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <section className="pricingFaq" aria-label="Preguntas frecuentes">
        ...
        <div className="faqGrid">
          ...
          <details className="faqItem">
            ...
            <p>Dos opciones: pago por contacto individual ($9.990 CLP por candidato aceptado) o plan ilimitado ($29.990 CLP/mes para contactos sin límite). Sin contratos de permanencia en ningún caso.</p>
          </details>
          <details className="faqItem">
