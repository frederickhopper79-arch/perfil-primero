...
export default function OfflinePage() {
  return (
    <main style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "2rem", textAlign: "center", background: "var(--bg)" }}>
      <img src="/logo-perfil-primero.png" alt="Perfil Primero" style={{ height: "48px", marginBottom: "2rem" }} />
      ...
      <button
        ...
        style={{ marginTop: "1.5rem", background: "#0094d4", color: "#fff", border: "none", borderRadius: "8px", padding: "10px 24px", fontWeight: 700, fontSize: "15px", cursor: "pointer" }}
      >
        Reintentar
      </button>
    </main>
