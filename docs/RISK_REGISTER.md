...
| RISK-004 | Emisión de documentos tributarios (boleta/DTE) al cobrar. | Media | Alto | `[completar]` | Mitigado (parcial) | **Inicio de actividades SII realizado** (RUT 78.449.783-6). Pendiente: credenciales OpenFactura para emisión automática de DTE. |
