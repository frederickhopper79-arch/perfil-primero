...
- El perfil pertenece al profesional.
...
En vez de que miles de personas postulen a una oferta, las empresas buscan talento ya disponible.

Los trabajadores crean un perfil vivo con:
...
Las empresas pueden buscar candidatos usando filtros claros:
...
### 1. Transparencia primero

La empresa no puede contactar a una persona sin mostrar:
...
### 2. No mas agujero negro

Cada contacto o invitacion tiene estados visibles:

- Enviada.
- Vista por el candidato.
- Aceptada.
- Rechazada.
- En entrevista.
- Oferta enviada.
...
El trabajador entra y crea su perfil una sola vez.
...
- Correo personal.
- CV descargable.
- Nombre completo, si el usuario prefiere anonimato parcial.

## Experiencia de la empresa

La empresa crea una cuenta verificada y busca talento.
...
- No parte desde ofertas masivas, parte desde talento disponible.
...
- Registro.
- Creacion de perfil laboral.
- Estado de disponibilidad.
- Renta esperada.
- Habilidades.
- Experiencia.
- Modalidad preferida.
- Panel de invitaciones recibidas.
...
Regla importante: el pago no debe prometer contratacion. Debe prometer visibilidad, herramientas y acceso a empresas verificadas.

### Cobro a empresas

La empresa paga USD 50 cuando encuentra y contrata, o cuando confirma el inicio de un proceso exitoso con un trabajador encontrado en la plataforma.

Para evitar abusos, el cobro debe asociarse a un evento claro:

- Contacto aceptado por el trabajador.
- Proceso avanzado.
- Contratacion confirmada.
- O liberacion de datos de contacto completos, segun la version comercial que se elija.

### Hipotesis comercial

El modelo combina:

- Suscripcion liviana del trabajador: USD 10 por 30 dias.
- Pago por resultado de la empresa: USD 50 por trabajador encontrado.

La promesa para el trabajador es: pagar poco para estar visible ante empresas activas y transparentes.

La promesa para la empresa es: pagar solo cuando encuentra talento util, sin publicar avisos masivos ni recibir cientos de postulaciones irrelevantes.
